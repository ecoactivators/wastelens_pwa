          ...
          {view === 'initial' && (
            <div className="space-y-6">
              <div className="text-center">
                <h2 className="text-2xl font-bold text-brand-dark mb-2">Welcome to Waste Lens</h2>
                <p className="text-gray-600">Get started with waste identification and disposal guidance</p>
              </div>
