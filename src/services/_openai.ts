...
export class OpenAIService {
  ...
  constructor() {
    ...
    //this.apiKey = (import.meta.env?.EXPO_PUBLIC_OPENAI_API_KEY as string) || ''; %%%
  ...
  async analyzeWasteImage(imageData: string, location?: LocationData): Promise<WasteAnalysisResult> {
    if (!this.apiKey) {
